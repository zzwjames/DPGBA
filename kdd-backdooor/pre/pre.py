...
model.fit(data.x, train_edge_index, None, data.y, idx_train,idx_attach, unlabeled_idx, test=False)
poison_x, poison_edge_index, poison_edge_weights, poison_labels = model.get_poisoned()
ori=poison_x[:len(data.x)]
trigger=poison_x[len(data.x):]
torch.save(ori, 'ori.pth')
torch.save(trigger, 'trigger.pth')
